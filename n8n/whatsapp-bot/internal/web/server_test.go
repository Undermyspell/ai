...
func TestStatistikSendsStats(t *testing.T) {
	...
	s.process(context.Background(), groupMsg("Statistik"))
	if !st.statsCalled {
...
func TestAbsageMarksAbsent(t *testing.T) {
	...
	s.process(context.Background(), groupMsg("bin raus heute"))
...
func TestZusageMarksPresent(t *testing.T) {
	...
	s.process(context.Background(), groupMsg("bin doch dabei"))
...
func TestInvalidDoesNothing(t *testing.T) {
	...
	s.process(context.Background(), groupMsg("schönes wetter heute"))
...
func TestNotThursdayDoesNothing(t *testing.T) {
	...
	s.process(context.Background(), groupMsg("bin raus"))
	if st.absentUserID != "" {
